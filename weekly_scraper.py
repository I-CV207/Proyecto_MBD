...
if os.getenv("INSTITUTIONS_FILE") and pathlib.Path(os.getenv("INSTITUTIONS_FILE")).exists():
    ...
    INSTITUTIONS: Dict[str, Dict[str, str | List[str]]] = {
        ...
        "base_url": "https://www.santander.com.mx",
        "product_patterns": [r"/personas/[^#?]*", r"/cuentas/", r"/tarjetas/", r"/creditos/"],
        },
        "banamex-mx": {
        "name": "Citibanamex",
        "base_url": "https://www.banamex.com",
        "product_patterns": [r"/personas/[^#?]*", r"/cuentas/", r"/tarjetas/", r"/creditos/"],
         },
        "hsbc-mx": {
        "name": "HSBC México",
        "base_url": "https://www.hsbc.com.mx",
        "product_patterns": [r"/personas/[^#?]*", r"/cuentas/", r"/tarjetas/", r"/creditos/"],
        },
    }
